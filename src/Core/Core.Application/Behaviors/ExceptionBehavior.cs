...
public class ExceptionBehavior<TRequest, TResponse>(ILogger<ExceptionBehavior<TRequest, TResponse?>> logger) : IPipelineBehavior<TRequest, TResponse?> where TRequest : notnull
{
